...
namespace PathfindingFramework.Patches.DevTool.PathDebugging
{
	...
	{
		// Code for debugging reachability issues.
			...
			TraverseParms traverseParams)
		{
			...
			string startTerrain = map != null ? start.GetTerrain(map).defName : "Unknown";
			string destStr = $"[{dest.Cell.x}, {dest.Cell.z}]";
			string destTerrain = map != null ? dest.Cell.GetTerrain(map).defName : "Unknown";
